    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      ...
      <div className="mt-16 p-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <p className="text-gray-600">support@schoollms.com</p>
                <p className="text-gray-600">info@schoollms.com</p>
              </div>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 rounded-lg hover:shadow-lg transition-all font-medium text-lg"
                  >
                    Send Message
                  </button>
                </form>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg shadow-lg p-12 text-white text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto mt-8">
              <div>
                <p className="text-blue-100 mb-2">Monday - Friday</p>
                <p className="text-2xl font-bold">9:00 AM - 6:00 PM</p>
              </div>
              <div>
                <p className="text-blue-100 mb-2">Saturday - Sunday</p>
